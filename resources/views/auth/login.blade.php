        ...
        <div class="row w-100 justify-content-center">
            <div class="col-12 col-md-8 col-lg-4">
                ...
                <div class="card login-card " style="min-height: 50dvh !important;">
                    <div class="card-body">
                        <p class="mt-2 fw-bold fs-2 text-center"><i>Instagram Clone</i></p>
                        <div class="px-3">
                            <form method="post" action="{{ route('check-user') }}">
                                <div class="row">
                                    <div class="col-md-12 mt-4">
                                        <input type="text" name="login_id" id="login_id" placeholder="Email or username"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-3">
                                    <p class="text-center">
                                        ...
                                        <a href="{{ route('registerUser') }}" class="text-decoration-none fw-bold">Sign
                                            up</a>
                                    </p>
                                </div>
                            </div>
